...
#  Feb 02, 2019 12:28:46 PM IST  platform: Windows NT
set vTcl(timestamp) ""
...
foreach img {
        ...
        {{[file join D:/ PythonProjects add.png]} {file not found!} user {}}
        {{[file join D:/ PythonProjects broken-heart.png]} {file not found!} user {}}
        {{[file join D:/ PythonProjects delete.png]} {file not found!} user {}}
        {{[file join D:/ PythonProjects like.png]} {file not found!} user {}}
        {{[file join D:/ PythonProjects pause.png]} {file not found!} user {}}
        {{[file join D:/ PythonProjects play.png]} {file not found!} user {}}
        {{[file join D:/ PythonProjects previous.png]} {file not found!} user {}}
        {{[file join D:/ PythonProjects refresh.png]} {file not found!} user {}}
        {{[file join D:/ PythonProjects stop.png]} {file not found!} user {}}
        {{[file join D:/ PythonProjects vinylrecord.png]} {file not found!} user {}}
...
proc vTclWindow.top42 {base} {
    ...
    ttk::label $top.tLa51 \
        ...
        -font $::vTcl(fonts,vTcl:font10,object) -relief flat -text 2:10 
    vTcl:DefineAlias "$top.tLa51" "songTotalDuration" vTcl:WidgetProc "Toplevel1" 1
    ttk::label $top.tLa53 \
        -background {#ffffff} -foreground {#000000} \
        -font $::vTcl(fonts,vTcl:font10,object) -relief flat -text 1:15 
    ...
    button $top.but61 \
        ...
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -image [vTcl:image:get_image [file join D:/ PythonProjects pause.png]] \
        -pady 0 -text Button 
    ...
    button $top.but62 \
        ...
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -image [vTcl:image:get_image [file join D:/ PythonProjects play.png]] \
        -pady 0 -text Button 
    ...
    button $top.but63 \
        ...
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -image [vTcl:image:get_image [file join D:/ PythonProjects stop.png]] \
        -pady 0 -text Button 
    ...
    label $top.lab64 \
        ...
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -image [vTcl:image:get_image [file join D:/ PythonProjects vinylrecord.png]] \
        -text Label 
    ...
    label $top.lab76 \
        ...
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -image [vTcl:image:get_image [file join D:/ PythonProjects previous.png]] \
        -text Label 
    ...
    button $top.but97 \
        ...
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -image [vTcl:image:get_image [file join D:/ PythonProjects add.png]] \
        -pady 0 -text Button 
    ...
    button $top.but98 \
        ...
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -image [vTcl:image:get_image [file join D:/ PythonProjects delete.png]] \
        -pady 0 -text Button 
    ...
    button $top.but103 \
        ...
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -image [vTcl:image:get_image [file join D:/ PythonProjects broken-heart.png]] \
        -pady 0 -text Button 
    ...
    button $top.but105 \
        ...
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -image [vTcl:image:get_image [file join D:/ PythonProjects like.png]] \
        -pady 0 -text Button 
    ...
    button $top.but107 \
        ...
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -image [vTcl:image:get_image [file join D:/ PythonProjects refresh.png]] \
        -pady 0 -text Button 
